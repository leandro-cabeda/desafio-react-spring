...
class AreasReservasRejeitadas extends React.Component {
    ...
    carregarLista=()=>{
        this.service.listarReservasRejeitadas()
            .then( resposta => {
    ...
    render(){
        ...
        return (
            <CardListagem title="Listagem de Reservas Rejeitadas">
                <div className="row">
...
export default withRouter(AreasReservasRejeitadas);
